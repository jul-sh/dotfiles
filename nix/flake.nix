{
  ...
  inputs = {
    ...
    # The upstream default branch currently references an unpublished v7.0.0
    # asset; use the latest stable release until that package metadata lands.
    keytap.url = "github:jul-sh/keytap/v6.4.1";
